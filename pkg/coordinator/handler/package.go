...
func AddPackage(ctx *gin.Context, client cpb.CoordinatorClient) {
	...
	email, Id, err := middleware.ValidateToken(ctx, "coordinator")
	if err != nil {
...
func ViewPackage(ctx *gin.Context,client cpb.CoordinatorClient){
	...
	var ctxt = context.Background()
	response, err := client.CoordinatorViewPackage(ctxt, &cpb.CoodinatorViewPackage{
...
func AddActivity(ctx *gin.Context, client cpb.CoordinatorClient) {
	...
	var ctxt = context.Background()
	response, err := client.CoordinatorAddActivity(ctxt, &cpb.AddActivity{
